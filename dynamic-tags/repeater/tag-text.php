 ...
 * @since 1.0.0
 */
Class Prek_Dynamic_Tag_Jet_Engine_Repeater_Text extends \Elementor\Core\DynamicTags\Tag {
    ...
    public function get_name() {
        return 'prek-repeater-value-text';
    }
    ...
    public function get_title() {
        return esc_html__( 'Repeater Field', 'prek-jetengine-addons' );
    }
